...
//czy przekazana nazwa użytkownika jest prawidłowa
    public boolean validateUsername(String username) {
        return username.matches("^[a-zA-Z0-9._-]{3,}$");
    }
//sprawdza poprawność przekazanego adresu e-mail:
...
//regexa – wyrażenia regularnego. Jest to wzorzec, jaki podana wartość musi spełnić.
